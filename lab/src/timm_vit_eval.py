...
def defaultargs() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=str,
        default='/home/jovyan/nas/yrc/model/timm/vit_base_patch16_224.augreg_in1k/model.safetensors',
    ...
    parser.add_argument(
        '--dataset-path',
        type=str,
        default='/home/jovyan/nas/yrc/dataset/imagenet-1k/val',
